 ...
 <button class="bg-red-500 px-2 py-1 m-1 rounded" type="button" data-modal-toggle="modal"> 
                       Login
 </button> 
                    ...
                    <form method ="POST" action="/sessionlogin"  id="modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
