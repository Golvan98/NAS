...
<div id="first container" class="mt-8 mx-6 flex-nowrap w-full h-auto bg-white border border-gray-300">  
        ...
        <div id="second container" class="flex w-full h-full bg-white items-center justify-center"> 
         ...
         <div id="third container" class="w-full h-auto flex-nowrap mx-4 border border-black bg-gray-300 mt-1">
                ...
                <div class="flex flex-wrap  bg-gray-300 px-2 py-1 w-1/5  h-auto truncate hover:text-clip border border-black"> <input type="checkbox"  name="question_choice[]"  id="question_choice[]" value="{{$choice->question_choice}}" @if {{$request()->get('question_choice')}} == $choice->question_choice) checked @endif> &nbsp {{$choice->question_choice}} </div> 
