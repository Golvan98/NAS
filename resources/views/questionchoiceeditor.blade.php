...
<div class="w-full h-full bg-gray-300 flex justify-center items-center">
    ...
    <div class="w-3/4 bg-gray-100 border border-black mt-16 mb-12">
            ...
            <div class="w-full flex justify-between mt-4">
             ...
             <button class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium px-8 py-2 rounded-xl ml-2 mb-2 mr-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="previewModal-{{ $QuestionChoice->id }}">
