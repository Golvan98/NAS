...
<div class="w-full h-full bg-gray-300 flex justify-center items-center">
    ...
    <div class="w-3/4 bg-gray-100 border border-black mt-16 mb-12">
            ...
            <div class="w-full flex justify-between mt-4">
             ...
             <button class="modal fade close block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium px-8 py-2 rounded-xl ml-2 mb-2 mr-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" data-dismiss="previewModal-{{ $QuestionChoice->id }}" type="button" data-modal-toggle="previewModal-{{ $QuestionChoice->id }}">
                Edit Question Choice 
             </button>
            
              
              <form method ="POST" action="/updatequestionchoice/{{$QuestionChoice->id}}"  id="previewModal-{{ $QuestionChoice->id }}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                  <div class="relative w-full h-full max-w-md p-4 md:h-auto">
                      <!-- Modal content -->
                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                          <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-dismiss="previewModal-{{ $QuestionChoice->id }}">
                          ...
                          <div class="px-6 py-6 lg:px-8">
                              ...
                              <div class="space-y-6">   
                                ...
                                @method('PATCH')
                                  ...
                                  <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" data-toggle="modal" data-id="{!! $QuestionChoice->id !!}" data-target="#previewModal-{{ $QuestionChoice->id }}">Edit Question Choice</button>                                
                              </div>
                          </div>
                      </div>
                  </div>
