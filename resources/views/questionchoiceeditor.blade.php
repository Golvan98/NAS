...
<div class="w-full h-full bg-gray-300 flex justify-center items-center">
    ...
    <div class="w-3/4 bg-gray-100 border border-black mt-16 mb-12">
            ...
            <div class="w-full h-full flex justify-between items-end mt-6 mr-2"> 
              ...
              <button class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium px-8 py-2 rounded-xl ml-2 mb-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="authentication-modal">
                Add Question Choice
              </button>
                  ...
                  <div class="relative w-full h-full max-w-md p-4 md:h-auto">
                      ...
                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                          ...
                          <div class="px-6 py-6 lg:px-8">
                              <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white"> Add a Question Choice</h3>
