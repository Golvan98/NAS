        ...
        <div class="flex justify-center items-start w-full h-3/4 bg-gray-300"> 
                ...
                <div id="first container" class="mt-8 mx-6 flex-nowrap w-full h-5/6 bg-white border border-gray-300">  
                        ...
                        <div id="third container" class="w-full h-auto flex-nowrap mx-4 border border-black bg-gray-300">
                                ...
                                <div class="w-full flex flex-wrap bg-gray-300 mt-4 flex-auto"> 

                                @foreach($choices as $choice)     

                                <div class="justify-between bg-gray-300 px-2 py-4 flex-auto truncate hover:text-clip border border-black items-center"> <input type="checkbox" name="question_choice[]" id="question_choice[]" value="{{$choice->question_choice}}"> &nbsp {{$choice->question_choice}} </div> 
                        ...
                        <div id="second container" class="flex w-full h-full bg-white items-center justify-center"> 
                                ...
                                <div id="third container" class="w-full h-auto flex-nowrap mx-4 border border-black bg-gray-300">
                                        ...
                                        <div class="w-full flex flex-wrap bg-gray-300 mt-4 "> 
                                                ...
                                                <input class="mx-2 bg-gray-300 w-full h-full py-8"  type="text" name="answer" id="answer" placeholder="Answer Here" value="{{old('answer')}}"> 
